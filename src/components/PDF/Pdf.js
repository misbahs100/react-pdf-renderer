...
import LebronStretch from "../../photos/tele.PNG";
...
const Pdf = () => {
    return (
        <PDFViewer style={{border: '12px solid red', height: '95vh', width: '95vw'}}>
            <Document >
                <Page size="A4"  >
                    <View><Text style={styles.header} fixed>Hello Bangladesh</Text></View>
                    <Text className="text-3xl">hello</Text>
                    <Test style={styles.header}/>
